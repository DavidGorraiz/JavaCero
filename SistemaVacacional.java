...
public class SistemaVacacional{
	public static void main(String args[]){
		...
		if(clave == 1){
			if(antiguedad == 1){
				System.out.println("El trabajdor " + nombre + " tiene derecho a 6 dias de vacaciones");
			...
			if(antiguedad == 1){
				System.out.println("El trabajdor " + nombre + " tiene derecho a 7 dias de vacaciones");
			} else if(antiguedad >= 2 && antiguedad <= 6){
			...
			if(antiguedad == 1){
				System.out.println("El trabajdor " + nombre + " tiene derecho a 10 dias de vacaciones");
			} else if(antiguedad >= 2 && antiguedad <= 6){
				System.out.println("El trabajador " + nombre + " tiene derecho a 20 dias de vacaciones");
			} else if(antiguedad >= 7){
